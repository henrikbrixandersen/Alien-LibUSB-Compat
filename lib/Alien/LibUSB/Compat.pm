...
Alien::LibUSB::Compat - installing, finding and using libusb-compat
...
In short C<Alien::LibUSB::Compat> can be used to detect and get configuration
settings from an installed libusb-compat.
...
Please report any bugs or feature requests to C<bug-alien-libusb-compat at rt.cpan.org>, or through
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=Alien-LibUSB-Compat>.  I will be notified, and then you'll
